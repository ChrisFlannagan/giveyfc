...
var FlexboxLayout = (function (_super) {
    ...
    FlexboxLayout.prototype.onOrderPropertyChanged = function (view, oldValue, newValue) {
        console.log("order changed: " + newValue + " " + view);
        this.setLayoutParamsProperty(view, function (lp) { return lp.order = newValue; });
    };
    FlexboxLayout.prototype.onFlexGrowPropertyChanged = function (view, oldValue, newValue) {
        console.log("flex-grow changed: " + newValue + " " + view);
        this.setLayoutParamsProperty(view, function (lp) { return lp.flexGrow = newValue; });
    };
    FlexboxLayout.prototype.onFlexShrinkPropertyChanged = function (view, oldValue, newValue) {
        console.log("flex-shrink changed: " + newValue + " " + view);
        this.setLayoutParamsProperty(view, function (lp) { return lp.flexShrink = newValue; });
    };
    FlexboxLayout.prototype.onAlignSelfPropertyChanged = function (view, oldValue, newValue) {
        console.log("align-self changed: " + newValue + " " + view);
        this.setLayoutParamsProperty(view, function (lp) { return lp.alignSelf = alignSelfMap[newValue]; });
    };
    FlexboxLayout.prototype.setLayoutParamsProperty = function (view, setter) {
