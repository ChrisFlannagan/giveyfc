	...
	$recurring_settings = array(
		...
		'fields'     => apply_filters( 'give_settings_recurring', array(
				...
				array(
					...
					'desc'    => __( 'Enter the email message that is sent to users when a subscription is cancelled. HTML is accepted. Available template tags:', 'give-recurring' ) . Give_Recurring()->emails->get_cancelled_email_tags() . '<br/>',
					'type'    => 'wysiwyg',
