...
add_filter( 'give_customer_recount_should_process_payment', 'give_recurring_should_process_payment', 10, 2 );
 ...
 */
function give_recurring_customer_recount_status( $payment_statuses ) {
...
add_filter( 'give_recount_customer_payment_statuses', 'give_recurring_customer_recount_status', 10, 1 );
...
add_filter( 'give_reset_store_items', 'give_recurring_reset_delete_sub_customer_ids', 10, 1 );
...
add_filter( 'give_reset_store_items', 'give_recurring_reset_delete_subscriptions', 10, 1 );
